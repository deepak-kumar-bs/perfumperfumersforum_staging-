...
<script type="text/javascript">
  function getOptionSaved(e) {
    var listingtype_id = e.options[e.selectedIndex].value;
    var field_id = e.id.substring(14);

    new Request.JSON({
        url: en4.core.basePath + 'recipefield/index/add-option',
        data: {
          format: 'json',
