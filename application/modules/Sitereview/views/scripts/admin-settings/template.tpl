...
$modules_array = array(
    ...
    'Documents Sharing Plugin - Google Docs Viewer' => 'https://www.socialengineaddons.com/socialengine-documents-sharing-plugin-google-docs-viewer',
    'Crowdfunding / Fundraising / Donations Plugin' => 'https://www.socialengineaddons.com/socialengine-crowdfunding-fundraising-donations-plugin',
);
