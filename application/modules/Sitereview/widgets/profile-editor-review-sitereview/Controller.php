 ...
 */
class Sitereview_Widget_ProfileEditorReviewSitereviewController extends Seaocore_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $this->view->can_create = Engine_Api::_()->authorization()->getPermission($level_id, 'user', "editor_review");
    ...
    $this->view->tab_id = Engine_Api::_()->sitereview()->getTabId($listingtype_id, 'sitereview.editor-reviews-sitereview');
    $params = array();
    ...
    $noReviewCheck = $reviewTable->getAvgRecommendation($params);
		...
		if (!empty($noReviewCheck)) {
			...
			$this->view->ratingDataTopbox = $ratingTable->ratingbyCategory($listing_id, 'editor', $resource_type);
		}
