 ...
 */
class Sitereview_Widget_ListFeaturedListingController extends Engine_Content_Widget_Abstract {

  public function indexAction() {

    $this->view->description  = $this->_getParam('description', '');
    $this->view->showMorelink  = $this->_getParam('showMorelink', 1);
    $values = array();
    ...
    $this->view->blockHeight = $values['blockHeight'] = $this->_getParam('blockHeight', 440);
    $this->view->blockWidth = $values['blockWidth'] = $this->_getParam('blockWidth', 350);
    ...
    $this->view->desc_truncation = $values['desc_truncation'] = $this->_getParam('desc_truncation', 100);
