 ...
 */
class Sitereview_Widget_PfBrowseListingsSitereviewController extends Seaocore_Content_Widget_Abstract {
	...
	public function indexAction() {
	    ...
	    $this->view->quick_specif = $this->_getParam('quick_specif', 1);
	    $this->view->quick_specif_mobile = $this->_getParam('quick_specif_mobile', 1);

	    // echo $this->view->quick_specif_mobile." try ".$this->view->quick_specif; die;
	   ...
	   $this->view->listingType= $this->view->viewTypeSM;
	    ...
	    if (empty($orderBy)) {
	      $values['orderby'] = $params['orderby'] = $this->_getParam('orderby', 'like_desc');
	    }
