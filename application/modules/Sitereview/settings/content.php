...
'),
  ...
  array(
        'title' => $view->translate('Featured / Sponsored Listings'),
        'description' => $view->translate('You can choose either featured or Sponsored or New Listings to show along with diverse options via settings of this widget.'),
        'category' => 'Multiple Listing Types',
        'type' => 'widget',
        'autoEdit' => true,
        ...
        'defaultParams' => array(
            ...
            'titleCount' => true,
            'showOptions' => array("category", "rating", "review", "wishlist"),
        ),
        'adminForm' => 'Sitereview_Form_Admin_Widgets_ListFeaturedListing',
    ),
    array(
        ...
        'adminForm' => array(
            'elements' => array(
                ...
                array(
                    ...
                    'emailme',
                    array(
                        'label' => $view->translate("Do you want users to send emails to Listing via a customized pop up when they click on 'Email Me' link?)"), 
                        'multiOptions' => array(
