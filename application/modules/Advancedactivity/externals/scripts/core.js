...
var submitFormAjax = function (submitUri, dumpComposeInstance) {
  ...
  var request = new Request.JSON({
    ...
    onSuccess: function (responseJSON) {
      ...
      } else if ($type(responseJSON) && responseJSON.flood == true) {
        en4.core.showError("<div class='aaf_show_popup'><p>" + en4.core.language.translate(responseJSON.floodMessage) + '</p><button onclick="Smoothbox.close()">Close</button></div>');
      } else {
