INSERT IGNORE INTO `engine4_core_modules` (`name`, `title`, `description`, `version`, `enabled`, `type`) VALUES  ('advancedactivity', 'Advanced Activity', 'Advanced Activity', '5.6.0p2', 1, 'extra') ;
