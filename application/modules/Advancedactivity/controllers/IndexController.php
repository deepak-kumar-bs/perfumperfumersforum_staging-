...
class Advancedactivity_IndexController extends Core_Controller_Action_Standard {
    ...
    public function postAction() {
        ...
        // Make form
        $form = $this->view->form = new Advancedactivity_Form_Post();
        ...
        try {
            ...
            if ((($currentcontent_type == 3) || isset($_POST['post_to_facebook'])) && (empty($postData['schedule_time']) || $postData['schedule_time'] == '0000-00-00')) {
                try {
...
//              }
            ...
            if ((($currentcontent_type == 2) || isset($_POST['post_to_twitter'])) && (empty($postData['schedule_time']) || $postData['schedule_time'] == '0000-00-00')) {
                try {
            ...
            if ((($currentcontent_type == 5) || isset($_POST['post_to_linkedin'])) && (empty($postData['schedule_time']) || $postData['schedule_time'] == '0000-00-00')) {
...
//              }
       ...
       if(isset($postData['min_age']) && !(empty($postData['min_age']) && isset($postData['max_age']) && empty($postData['max_age']) && isset($postData['who']) && empty($postData['who'])) || $postData['min_age']<$postData['max_age']){
...
//        }
            ...
            if ($object_type == 'sitepage_page' && !empty(Engine_Api::_()->advancedactivity()->checkVersion($sitepageVersion, '4.2.9p3'))) {
...
//                }
    ...
    public function welcometabAction() {
        ...
        if (empty(Engine_Api::_()->advancedactivity()->checkVersion($coreversion, '4.1.0'))) {
