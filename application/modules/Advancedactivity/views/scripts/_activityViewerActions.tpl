...
document.getElementById("' . $this->commentForm->body->getAttrib('id') . '").focus();document.getElementById("' . "comment-likes-activityboox-item-$actionBaseId" . '").style.display = "block"; ', 'title' =>
    ...
    <?php // Share  ?>
    <?php $shareableItem = $action->shareable ? $action->getShareableItem() : false; ?>
                ...
                <ul class="comments_date">
                  ...
                  if( $canComment ):
                    ...
                    <li class="comments_like"> 
                      &#183;
                      <?php if( !$isLiked ): ?>
                        <a href="javascript:void(0)" class='unliked_comment' onclick="en4.advancedactivity.like(this,<?php echo sprintf("'%d', %d", $action->getIdentity(), $comment->getIdentity()) ?>);" action-title="<?php echo $this->translate('unlike') ?>">
                          <?php echo $this->translate('like') ?>
                        </a>
                      <?php else: ?>
                        <a href="javascript:void(0)" class='liked_comment' onclick="en4.advancedactivity.unlike(this,<?php echo sprintf("'%d', %d", $action->getIdentity(), $comment->getIdentity()) ?>);" action-title="<?php echo $this->translate('like') ?>">
