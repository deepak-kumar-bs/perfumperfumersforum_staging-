...
<div class="admin_seaocore_files_wrapper">
    <ul class="admin_seaocore_files seaocore_faq">	
        ...
        <li>
            <a href="javascript:void(0);" onClick="faq_show('faq_27');"><?php echo $this->translate("Why facebook publish button is not working in activity feed whenever I am posting something ?");?></a>
            <div class='faq' style='display: none;' id='faq_27'>
                <?php echo $this->translate("With the recent changes made by Facebook in its platform, Facebook has deprecated “publish_actions” permission and so, it is now not possible to publish status from Activity Feeds to Facebook Timeline. Any content can only be shared on Facebook timeline via the use of Facebook Share Dialogue. So, accordingly we have updated the code of our Advanced Activity Feed Plugin and now, Facebook icon that used to appear on the status box while making any post on Members home page will not show. The icon will appear only at the time of publishing a status from a page or a group, because Facebook only allows publishing of feeds to Facebook pages or Facebook groups only when the post is published via any page or any group.");?>
            </div>
        </li>
        <li>
            <a href="javascript:void(0);" onClick="faq_show('faq_28');"><?php echo $this->translate("Is publish_actions permission deprecated?");?></a>
            <div class='faq' style='display: none;' id='faq_28'>
                <?php echo $this->translate("Yes, publish_actions permission has been deprecated and now feeds can be published to Facebook timeline via the use of Share Dialogue only for which no permission is needed to be approved by Facebook, you need to configure Facebook app with required redirect URLs.");?>
            </div>
        </li>
    </ul>
</div>