...
<script type="text/javascript">
  ...
  (function () {
      ...
      var activityViewMore = function (next_id, subject_guid) {
          ...
          var request = new Request.HTML({
              ...
              onSuccess: function (responseTree, responseElements, responseHTML, responseJavaScript) {
                  ...
                  //it resolve the content overlap issue in pinboard
                  if(en4.advancedactivity.pinboard) {
      ...
      en4.core.runonce.add(function () {
          ...
          {
              var scrollAafFeed = true;
              if ($$('.layout_core_container_tabs') && $$('.layout_core_container_tabs').length > 0 && !(document.getElement('.tab_layout_advancedactivity_home_feeds').hasClass('active'))) {
                scrollAafFeed = false;
              }
              if (scrollAafFeed && (maxAutoScrollAAF == 0 || countScrollAAFSocial < maxAutoScrollAAF) && autoScrollFeedAAFEnable && activity_type == 1 && $('feed_viewmore')) {
