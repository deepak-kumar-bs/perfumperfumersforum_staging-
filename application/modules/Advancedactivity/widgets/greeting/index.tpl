...
<?php if(!empty($this->userItSelfBirthday)): ?>
    <a class="aaf_close_greeting" id="aaf_close_greeting" onclick="resetBirthDayGreeting(this, 'has_seen_own', true)" title="Close"></a>
...
<a class="aaf_close_greeting" id="aaf_close_greeting" onclick="resetBirthDayGreeting(this, 'has_seen', true, true)" title="Close"></a>
<div class="aaf_birthday_greeting_wrapper">
    <?php foreach($this->todaysBirthday as $id):?>
        ...
        <div class="aaf_birthday_greeting_wrapper-action"><span class="aaf_birthday_greeting_wrapper-action-post" onclick="resetBirthDayGreeting(this, 'has_seen_user_<?php echo $id; ?>', false, true)"><a href="<?php echo $user->getHref() ?>"> <?php echo $this->translate('Write a post') ?></a></span><span class="aaf_birthday_greeting_wrapper-action-message" onclick="resetBirthDayGreeting(this, 'has_seen_user_<?php echo $id; ?>', false, true)"><a href="<?php echo $this->baseUrl('messages/compose') ?>/to/<?php echo $user->getIdentity() ?>"><?php echo $this->translate('Message') ?></a></span></div>
        </div>
    <?php endforeach; ?>
</div>
...
<div class="aaf_find_friend_wrapper">
    <div class="aaf_find_friend_heading"><?php echo $this->translate('Add More Friends') ?><a class="aaf_close_greeting" id="aaf_close_greeting" onclick="resetBirthDayGreeting(this, 'has_seen_find', true)" title="Close"></a></div>
...
<?php endif; ?>
<script type="text/javascript">
function resetBirthDayGreeting(el, resetName, hideParent = false, nextDay = false) {
    var d = new Date();
    if (nextDay) {
        d.setHours(0, 0, 0, 0);
    ...
    el.getParent('.layout_advancedactivity_greeting').hide();     
}
</script>