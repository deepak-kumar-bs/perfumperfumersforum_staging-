...
//            $params['location'] = $_GET['location'];
        ...
        if (!in_array('sitereview', $enabledModules) && empty($params['viewType'])) {
        ...
        if ($params['user_id'] || (isset($params['category_id']) && !empty($params['category_id'])) || $params['listingtype_id'] == '18') {
