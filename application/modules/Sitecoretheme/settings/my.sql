...
INSERT IGNORE INTO `engine4_core_modules` (`name`, `title`, `description`, `version`, `enabled`, `type`) VALUES  ('sitecoretheme', 'Versatile - Responsive Multi-Purpose Theme', 'Versatile - Responsive Multi-Purpose Theme', '5.6.1', 1, 'extra') ;
...
('sitecoretheme_social_site_facebook', 'core', 'Facebook', '', '{"uri": "","target":"_blank", "icon":"fa fa-facebook"}', 'sitecoretheme_social_sites', 1, 1, 1),
('sitecoretheme_social_site_twitter', 'core', 'Twitter', '', '{"uri": "","target":"_blank", "icon":"fa fa-twitter"}', 'sitecoretheme_social_sites', 1, 1, 2),
('sitecoretheme_social_site_linkedin', 'core', 'Linkedin', '', '{"uri": "","target":"_blank", "icon":"fa fa-linkedin"}', 'sitecoretheme_social_sites', 1, 1, 3),
('sitecoretheme_social_site_youtube', 'core', 'Youtube', '', '{"uri": "","target":"_blank", "icon":"fa fa-youtube"}', 'sitecoretheme_social_sites', 1, 1, 4),
--  ('sitecoretheme_social_site_googleplus', 'core', 'Google +', '', '{"uri": "","target":"_blank", "icon":"fa-google-plus"}', 'sitecoretheme_social_sites', 1, 1, 5),
('sitecoretheme_social_site_pinterest', 'core', 'Pinterest', '', '{"uri": "","target":"_blank", "icon":"fa fa-pinterest"}', 'sitecoretheme_social_sites', 1, 1, 6)
