					...
					<?php if ($this->settings('sitecoretheme.landing.slider.frontImage.src')): ?>
						<div class="sitecoretheme_images_middle_front_image  _front_image_<?php echo $this->settings('sitecoretheme.landing.slider.frontImage.position', 'left') ?>">
							<div style="text-align: <?php echo $this->settings('sitecoretheme.landing.slider.frontImage.position', 'left') ?>">
								<img src="<?php echo Engine_Api::_()->core()->getFileUrl( $this->settings('sitecoretheme.landing.slider.frontImage.src')); ?>"/>
							</div>
						</div>
					<?php endif; ?>
...
<!--	<style type="text/css">
	...
	<script type="text/javascript">
      ...
      // valid length
      if ( pswd.length < 6) {
        $$('.seaocore_popup_user_form_signup')[0].getElementById('passwordroutine_length').removeClass('valid').addClass('invalid');
      } else {
        $$('.seaocore_popup_user_form_signup')[0].getElementById('passwordroutine_length').removeClass('invalid').addClass('valid');
      }

      //validate special character
      if ( pswd.match(/[#?!@$%^&*-]/) ) {
          if ( pswd.match(/[\\\\:\/]/) ) {
              $$('.seaocore_popup_user_form_signup')[0].getElementById('passwordroutine_specialcharacters').removeClass('valid').addClass('invalid');
          } else {
              $$('.seaocore_popup_user_form_signup')[0].getElementById('passwordroutine_specialcharacters').removeClass('invalid').addClass('valid');
          }
      } else {
          $$('.seaocore_popup_user_form_signup')[0].getElementById('passwordroutine_specialcharacters').removeClass('valid').addClass('invalid');
      }
      ...
      if ( pswd.match(/[A-Z]/) ) {
          $$('.seaocore_popup_user_form_signup')[0].getElementById('passwordroutine_capital').removeClass('invalid').addClass('valid');
      } else {
          $$('.seaocore_popup_user_form_signup')[0].getElementById('passwordroutine_capital').removeClass('valid').addClass('invalid');
      }

      //validate small letter
      if ( pswd.match(/[a-z]/) ) {
          $$('.seaocore_popup_user_form_signup')[0].getElementById('passwordroutine_lowerLetter').removeClass('invalid').addClass('valid');
      } else {
          $$('.seaocore_popup_user_form_signup')[0].getElementById('passwordroutine_lowerLetter').removeClass('valid').addClass('invalid');
      }

      //validate number
      if ( pswd.match(/\d{1}/) ) {
          $$('.seaocore_popup_user_form_signup')[0].getElementById('passwordroutine_number').removeClass('invalid').addClass('valid');
      } else {
          $$('.seaocore_popup_user_form_signup')[0].getElementById('passwordroutine_number').removeClass('valid').addClass('invalid');
      }
  }
	</script>