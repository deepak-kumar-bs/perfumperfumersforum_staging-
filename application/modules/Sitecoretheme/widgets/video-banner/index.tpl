...
<div class="sitecoretheme_video_banner_wrapper" style=" background-color:">
  <?php $src = Engine_Api::_()->core()->getFileUrl($this->settings('sitecoretheme.landing.videobanner.image') ?: 'application/modules/Sitecoretheme/externals/images/video-baanner.jpg' ); ?>
