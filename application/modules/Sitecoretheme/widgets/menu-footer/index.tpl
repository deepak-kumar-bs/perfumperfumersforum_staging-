          ...
          <?php if( !empty($this->social_links_array[0]) && ( !empty($this->facebook_url) || !empty($this->twitter_url) ||  !empty($this->linkedin_url) || !empty($this->youtube_url) || !empty($this->pinterest_url) )): ?>
            ...
            <ul class="social_bottom_icons">
              <?php if( !empty($this->facebook_url) ) : ?>
                      <li><a href="<?php echo $this->facebook_url ?>" target="_blank" title="<?php echo $this->facebook_title ?>"><i class="fab fa-facebook"></i></a></li>
                  <?php endif; ?>
              ...
              <?php if( !empty($this->youtube_url) ) : ?>
                      <li><a href="<?php echo $this->youtube_url ?>" target="_blank" title="<?php echo $this->youtube_title ?>"><i class="fab fa-youtube"></i></a></li>
                  <?php endif; ?>
              <?php if( !empty($this->pinterest_url) ) : ?>
                      <li><a href="<?php echo $this->pinterest_url ?>" target="_blank" title="<?php echo $this->pinterest_title ?>"><i class="fab fa-pinterest"></i></a></li>
                  <?php endif; ?>
            </ul>
          <?php endif; ?>
...
<?php if(!empty($this->viewer_id) && $this->checkVersion) { ?>
