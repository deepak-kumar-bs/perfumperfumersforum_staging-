...
Path Name: " . $global_directory_name . "</span>";
  ...
  public function multiDeleteBannersAction()
  {
    ...
    return $this->_helper->redirector->gotoRoute(array('action' => 'inner-images'));
  }
  ...
  public function getImageSrcAction()
  {
    $this->view->actualImageurl = Engine_Api::_()->core()->getFileUrl($this->_getParam('image')); 
  }
}