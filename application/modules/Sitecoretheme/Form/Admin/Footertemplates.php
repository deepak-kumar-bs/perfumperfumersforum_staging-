...
class Sitecoretheme_Form_Admin_Footertemplates extends Engine_Form {
	...
	public function init() {
		...
		$logoBackgroundOptions = Engine_Api::_()->sitecoretheme()->getImages(array('application/modules/Sitecoretheme/externals/images/default_footer_bg.png' => 'Default Image'));
