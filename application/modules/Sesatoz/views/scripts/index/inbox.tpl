 ...
 * @version    $Id: inbox.tpl  2018-10-05 00:00:00 SocialEngineSolutions $
...
<script type="text/javascript">
  ...
  function markallmessage() {
    ...
    en4.core.request.send(new Request.JSON({
      url : en4.core.baseUrl + 'sesatoz/index/markallmessage',
      data : {
        format: 'json'
      },
      onSuccess : function(responseJSON) {
        if($('sesatoz_messages_menu')){
          var message_children = $('sesatoz_messages_menu').getChildren('li');
  ...
  function deleteMessage(id, event) {
    ...
    en4.core.request.send(new Request.JSON({
      url : en4.core.baseUrl + 'sesatoz/index/delete-message',
      data : {
        format     : 'json',
        'id' : id
      }
