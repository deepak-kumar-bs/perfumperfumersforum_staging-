 ...
 * @version    $Id: manage.tpl  2018-10-05 00:00:00 SocialEngineSolutions $
...
<?php if( count($this->paginator) ): ?>
  ...
  <div>
  	 <div class="sesbasic_search_reasult">
    	<?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sesatoz', 'controller' => 'manage-banner', 'action' => 'index'), $this->translate("Back to Manage Banner Slideshow"), array('class'=>'sesbasic_icon_back buttonlink')); ?>
      </div>
        ...
        <br />
        <div>
         <div class="sesbasic_search_reasult"><?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sesatoz', 'controller' => 'manage-banner', 'action' => 'create-slide','id'=>$this->banner_id), $this->translate("Upload New Photo Slide"), array('class'=>'buttonlink sesbasic_icon_add')); ?>
			</div>
        </div>
        <?php if( count($this->paginator) ): ?>
  <div class="sesbasic_search_reasult">
        ...
        <?php if(count($this->paginator) > 0):?>
            ...
            <?php foreach ($this->paginator as $item) : ?>
              <li class="item_label" id="slide_<?php echo $item->slide_id ?>">
                ...
                <div style="width:20%;" class="admin_table_centered">
                  <?php echo ( $item->enabled ? $this->htmlLink(array('route' => 'admin_default', 'module' => 'sesatoz', 'controller' => 'manage-banner', 'action' => 'enabled', 'banner_id' => $this->banner_id, 'id' => $item->slide_id), $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sesbasic/externals/images/icons/check.png', '', array('title' => $this->translate('Disable'))), array()) : $this->htmlLink(array('route' => 'admin_default', 'module' => 'sesatoz', 'controller' => 'manage-banner', 'action' => 'enabled', 'banner_id' => $this->banner_id, 'id' => $item->slide_id), $this->htmlImage('application/modules/Sesbasic/externals/images/icons/error.png', '', array('title' => $this->translate('Enable')))) ) ?>
                </div>  
                <div style="width:20%;">
                  <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sesatoz', 'controller' => 'manage-banner', 'action' => 'create-slide', 'slide_id' => $item->slide_id,'id'=>$this->banner_id), $this->translate("Edit"), array()) ?>
									|
									<?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sesatoz', 'controller' => 'manage-banner', 'action' => 'delete-slide', 'id' => $item->slide_id, 'type' => strtolower($item->file_type) == 'jpeg' || strtolower($item->file_type) == 'jpg' || strtolower($item->file_type) == 'png' ? 'Photo' : 'Video'), $this->translate("Delete"), array('class' => 'smoothbox')) ?>
                </div>
              </li>
            <?php endforeach; ?>
          </ul>
...
<style type="text/css">
.sesatoz_manage_form_head > div,
.sesatoz_manage_form_list li > div{
