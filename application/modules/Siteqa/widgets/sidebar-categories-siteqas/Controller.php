...
class Siteqa_Widget_SidebarCategoriesSiteqasController extends Engine_Content_Widget_Abstract {

  public function indexAction() {
    //GET SITEFAQ API
		$this->view->siteqa_api = $siteqa_api = Engine_Api::_()->siteqa();

		//GET DOCUMENT CATEGORY TABLE
    $this->view->categoryTable = $tableCategory = Engine_Api::_()->getDbTable('categories', 'siteqa');
