 ...
 */
class Siteqa_Form_Admin_Item extends Engine_Form {

  protected $_field;

  public function init() {
    $this->setMethod('post');
    $this->setTitle('Add a Question of the Day')
            ->setDescription('Select a start date and end date below and the corresponding Question from the auto-suggest Question field. The selected Question will be displayed as "Question of the Day" for this duration and if more than one Questions are found to be displayed in the same duration then they will be dispalyed randomly one at a time.');
