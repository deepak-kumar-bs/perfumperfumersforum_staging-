 ...
 * @license    http://www.socialengine.com/license/
 */
class Activity_Widget_PfTagFeedController extends Engine_Content_Widget_Abstract
{
  ...
  public function indexAction()
  {
    ...
    $contentTypeOptions = $this->_getParam('contentTypeOptions', 'all');
    ...
    $config['listingProfileTags'] = $subject->custom_profiletags;
    ...
    do {
      ...
      // } else {
        $actions = $actionTable->getListingActivityByCustomPlofileTags($viewer, $tmpConfig, $subject);
      // }
      $selectCount++;
