...
//    $curr_module_version = strcasecmp($is_enabled->version, $SocialEngineAddOns_version);        
      ...
      $shouldUpgrade = checkVersion_sitereviewlistingtype($running_version,$product_version);
...
function checkVersion_sitereviewlistingtype($databaseVersion, $checkDependancyVersion) {
    $f = $databaseVersion;
