...
en4.core.runonce.add(function() {
  ...
  var changeFields = window.changeFields = function(element, force, isLoad) {
    ...
    getFieldsElements('.parent_' + field_id).each(function(childElement) {
      ...
      var childContainer;
      if( childElement.getParent('form') && childElement.getParent('form').get('class') == 'field_search_criteria' ) {
      ...
      var childIsVisible =  (childContainer == null) ? '' :( 'none' != childContainer.getStyle('display') );
